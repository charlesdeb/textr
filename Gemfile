...
group :development do
  ...
  # gem 'rack-mini-profiler', '~> 2.0' # commented out because of this: https://github.com/MiniProfiler/rack-mini-profiler/pull/157
  gem 'listen', '~> 3.3'
  # Spring speeds up development by keeping your application running in the background. Read more: https://github.com/rails/spring
  gem 'spring'
  gem 'spring-watcher-listen'
  gem 'htmlbeautifier' # for ERB formatting
end
